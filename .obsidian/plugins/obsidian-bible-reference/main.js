...
var VerseSuggesting = class {
 ...
 ${this.getVerseReference()}`;
    ...
    if ((_b = this.settings) == null ? void 0 : _b.bookBacklinking) {
      head += ` [[${this.bookName}]]`;
    }
    if ((_c = this.settings) == null ? void 0 : _c.chapterBacklinking) {
      head += ` [[${this.bookName + this.chapterNumber}]]`;
    }
    if (((_d = this.settings) == null ? void 0 : _d.bibleTagging) || ((_e = this.settings) == null ? void 0 : _e.bookTagging) || ((_f = this.settings) == null ? void 0 : _f.chapterTagging)) {
      bottom += " %%";
      bottom += ((_g = this.settings) == null ? void 0 : _g.bibleTagging) ? " #bible" : "";
      bottom += ((_h = this.settings) == null ? void 0 : _h.bookTagging) ? ` #${this.bookName}` : "";
      bottom += ((_i = this.settings) == null ? void 0 : _i.chapterTagging) ? ` #${this.bookName + this.chapterNumber}` : "";
      bottom += " %%";
    }
...
async function getSuggestionsFromQuery(query, settings) {
  ...
  const rawBookName = (_a = query.match(BOOK_REG)) == null ? void 0 : _a.first();
  if (!rawBookName) {
...
var VerseEditorSuggester = class extends import_obsidian2.EditorSuggest {
  ...
  async getSuggestions(context) {
    ...
    suggestionsEl.hide();
    const loadingContainer = suggestEl.getElementsByClassName("obr-loading-container")[0];
