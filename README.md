...
```sh
# Arch (pacman)
pacman -S accountsservice alsa-firmware alsa-plugins alsa-utils amd-ucode archinstall ark aspell audacious b43-fwcutter base base-devel bash-completion bat bind blender bluedevil bluez bluez-utils borg breeze-gtk btrfs-progs calibre cantarell-fonts chromium cryptsetup cups curl-impersonate-bin darktable device-mapper diffutils digikam distrobox dmidecode dmraid dnsmasq docker dolphin dolphin-plugins dosbox dosfstools downgrade dracut duf e2fsprogs easyeffects efibootmgr efitools elisa endeavouros-keyring endeavouros-mirrorlist endeavouros-theming eos-bash-shared eos-dracut eos-hooks espeakup ethtool exfat-utils eza f2fs-tools fastfetch festival festival-us ffmpegthumbnailer ffmpegthumbs firefox firewalld flatpak foliate fsarchiver fwupd gimp git glances gnome-dictionary godot gparted grub gst-libav gst-plugin-pipewire gst-plugins-bad gst-plugins-ugly gwenview handbrake haruna haveged hdparm hugo hunspell-es_es hwdetect hwinfo inetutils inkscape inxi iptables-nft iwd jfsutils jq kate kcalc kde-cli-tools kde-gtk-config kdeconnect kdegraphics-thumbnailers kdenetwork-filesharing kdenlive kdeplasma-addons keepassxc kgamma kimageformats kinfocenter kio-admin kio-extras kio-fuse kmouth konsole kscreen kwallet-pam kwayland-integration less lib32-glibc lib32-glu libappindicator-gtk3 libdvdcss libgsf libopenraw libreoffice-fresh libwnck3 linux linux-firmware linux-headers lmms logrotate lsb-release lsscsi lutris lvm2 maliit-keyboard man-db man-pages mangohud marble mdadm meld mesa-utils mingw-w64-gcc mlocate modemmanager mtools musescore mypaint nano nano-syntax-highlighting neovim netctl networkmanager networkmanager-openconnect networkmanager-openvpn nfs-utils nilfs-utils nmap noto-fonts noto-fonts-cjk noto-fonts-emoji noto-fonts-extra npm nss-mdns ntfs-3g ntp nvidia nvidia-hook nvidia-inst nvidia-settings obs-studio obsidian okular opencl-headers openssh os-prober p7zip pacman-contrib pandoc-cli pavucontrol perl picard pipewire-alsa pipewire-jack pipewire-pulse pkgfile plasma-browser-integration plasma-desktop plasma-disks plasma-firewall plasma-nm plasma-pa plasma-systemmonitor plasma-workspace poppler-glib power-profiles-daemon powerdevil print-manager pv python qbittorrent qemu-base rclone rebuild-detector reflector reiserfsprogs rsync rtkit s-nail sddm-kcm sg3_utils smartmontools sof-firmware sox spectacle speech-dispatcher starship steam sudo swt sysfsutils systemd-sysvcompat telegram-desktop tenacity tesseract texinfo tldr tmux tree ttf-bitstream-vera ttf-dejavu ttf-firacode-nerd ttf-liberation ttf-opensans unrar unzip upower usb_modeswitch usbutils veracrypt vi virt-manager virtualbox virtualbox-host-modules-arch visual-studio-code-bin wget which wine wine-mono winetricks wireplumber wpa_supplicant xdg-desktop-portal-kde xdg-user-dirs xdg-utils xf86-input-libinput xfsprogs xl2tpd xorg-server xorg-xdpyinfo xorg-xinit xorg-xinput xorg-xkill xorg-xrandr xsettingsd xterm xwaylandvideobridge

# Arch (yay)
yay -S bitwig-studio bottles gpu-screen-recorder-gtk-git megasync nvm protonup-qt spotify visual-studio-code-bin

# Flatpak (packages)
flatpak install com.github.tchx84.Flatseal com.mardojai.DiccionarioLengua com.usebottles.bottles dev.bragefuglseth.Fretboard io.github.sigmasd.stimulator net.mkiol.SpeechNote org.gnome.gitlab.YaLTeR.VideoTrimmer org.openstreetmap.josm
```

---

## Config files on UNIX
